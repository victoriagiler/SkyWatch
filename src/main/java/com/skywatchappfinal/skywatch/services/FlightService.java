...
import com.skywatchappfinal.skywatch.repositories.FlightRepository;
...
public class FlightService {
    ...
    public Flight getFlightById(Integer id){
        Optional<Flight> optionalFlight = flightRepository.findById(Integer.valueOf(String.valueOf(id)));
...
//            if the flight does not exist, this is what will be returned
        ...
        flightRepository.deleteById(Integer.valueOf(String.valueOf(id)));
